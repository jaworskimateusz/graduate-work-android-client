...
public final class ReportProblemActivity extends pl.jaworskimateusz.machineservice.activity.base.BaseActivity {
    ...
    @org.jetbrains.annotations.Nullable()
    public final android.widget.TextView getEtProblemDescription() {
        return null;
    }
    
    public final void setEtProblemDescription(@org.jetbrains.annotations.Nullable()
    android.widget.TextView p0) {
    }
    
    @org.jetbrains.annotations.Nullable()
    public final android.widget.TextView getEtKeywords() {
        return null;
    }
    
    public final void setEtKeywords(@org.jetbrains.annotations.Nullable()
    android.widget.TextView p0) {
    }
